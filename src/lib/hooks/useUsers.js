...
const useUsers = (filters) => {
    ...
    const setData = (newData, newCount) => setUsers({data: newData, count: newCount, loading: false, error: false})
    
    const setError = () => setUsers({data: [], count: 0, loading: false, error: true})
